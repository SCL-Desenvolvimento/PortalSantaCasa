...
- Create Angular project with ng: `ng new portalsantacasa.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`portalsantacasa.client.esproj`).
